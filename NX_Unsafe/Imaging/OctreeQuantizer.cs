...
namespace NX.Imaging
{
    public unsafe class OctreeQuantizer : Quantizer
    {
        ...
        /// <summary>
        /// Maximum allowed bits per color
        /// </summary>
        ...
        {
            if (maxColors > 256)
                throw new ArgumentOutOfRangeException("maxColors", maxColors, "The number of colors should be at most 256");

            if ((maxColorBits < 1) | (maxColorBits > 8))
                throw new ArgumentOutOfRangeException("maxColorBits", maxColorBits, "This should be between 1 and 8");

            this._maxColorBits = maxColorBits;
            this._maxColors = maxColors - 1;     // This is index.
        }

        public override void Init()
        {
            // Construct the octree
            this._octree = new Octree(this._maxColorBits);            
        }
        /// <summary>
        ...
        private class Octree
        {
            ...
            public Octree(int maxColorBits)
            {
                ...
                this._root = new OctreeNode(0, _maxColorBits, this);
            ...
            protected class OctreeNode
            {
                ...
                public int Reduce()
                {
                    ...
                    for (int index = 0; index < 8; index++)
                    {
                        ...
                        {
                            this._red += _children[index]._red;
                            this._green += _children[index]._green;
                            this._blue += _children[index]._blue;
                            this._pixelCount += _children[index]._pixelCount;
                            ++children;
